...
public class Banks extends Parameter{
    ...
    public void initialize() throws SQLException, GuanzonException{
        ...
        poModel = new ParamModels(poGRider).Banks();
    ...
    protected void saveComplete() {
        //Every lazy Banks() accessor across the model layer serves repeat lookups for this id
        //from ReferenceCache - drop the stale snapshot now that the record has changed.
        ReferenceCache.invalidate("Banks", poModel.getBankID());
    }
