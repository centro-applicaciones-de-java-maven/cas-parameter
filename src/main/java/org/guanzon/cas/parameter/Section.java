...
public class Section extends Parameter{
    ...
    public void initialize() throws SQLException, GuanzonException{
        ...
        poModel = new ParamModels(poGRider).Section();
    ...
    protected void saveComplete() {
        //Every lazy Section() accessor across the model layer serves repeat lookups for this id
        //from ReferenceCache - drop the stale snapshot now that the record has changed.
        ReferenceCache.invalidate("Section", poModel.getSectionId());
    }
