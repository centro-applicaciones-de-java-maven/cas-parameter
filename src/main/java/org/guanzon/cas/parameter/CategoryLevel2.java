...
public class CategoryLevel2 extends Parameter{
    ...
    public void initialize() {
        ...
        poModel = new Model_Category_Level2();
        poModel.setApplicationDriver(poGRider);
        poModel.setXML("Model_Category_Level2");
        poModel.setTableName("Category_Level2");
        poModel.initialize();
    }
    ...
    public JSONObject voidTransaction() {
        ...
        if (poModel.getCategoryId() == null || poModel.getCategoryId().isEmpty()) {
            poJSON.put("result", "error");
            poJSON.put("message", "No record loaded.");
            return poJSON;
        }
        ...
        if ("success".equals(poJSON.get("result"))) {
            ...
            poJSON.put("message", "The Categeory Level 2 has been activated successfully.");
        } else {
            poGRider.rollbackTrans();
