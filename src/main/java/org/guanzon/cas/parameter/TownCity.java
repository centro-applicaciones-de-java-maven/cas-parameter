...
public class TownCity extends Parameter{
    ...
    protected void saveComplete() {
        //Every lazy TownCity()/Town() accessor across the model layer serves repeat lookups for
        //this id from ReferenceCache - drop the stale snapshot now that the record has changed.
        ReferenceCache.invalidate("TownCity", poModel.getTownId());
    }
    ...
    public JSONObject openRecord(String Id) throws SQLException, GuanzonException {
        ...
        if ("success".equals((String) poJSON.get("result"))){
            poModel.setProvinceId(poModel.getProvinceId());
        }
