...
public class InvType extends Parameter{
    ...
    protected void saveComplete() {
        //Every lazy InvType()/Inv_Type() accessor across the model layer serves repeat lookups
        //for this id from ReferenceCache - drop the stale snapshot now that the record has changed.
        ReferenceCache.invalidate("Inv_Type", poModel.getInventoryTypeId());
    }
