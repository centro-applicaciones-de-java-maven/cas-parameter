...
public class Size extends Parameter{
    ...
    public void initialize() {
        ...
        poModel = new Model_Size();
        poModel.setApplicationDriver(poGRider);
        poModel.setXML("Model_Size");
        poModel.setTableName("Size");
        poModel.initialize();
    }
    ...
    public JSONObject isEntryOkay() {
        ...
        if (poGRider.getUserLevel() < UserRight.SYSADMIN){
            ...
            if (poModel.getSizeId().isEmpty()){
                poJSON.put("result", "error");
                poJSON.put("message", "Size must not be empty.");
                return poJSON;
            }
            
            if (poModel.getSizeName()== null ||  poModel.getSizeName().isEmpty()){
                poJSON.put("result", "error");
                poJSON.put("message", "Size must not be empty.");
                return poJSON;
            }
    ...
    public JSONObject voidTransaction() {
        ...
        if (poModel.getSizeId()== null || poModel.getSizeId().isEmpty()) {
            poJSON.put("result", "error");
            poJSON.put("message", "No record loaded.");
            return poJSON;
        }
