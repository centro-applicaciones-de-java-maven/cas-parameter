...
public class Labor extends Parameter{
    Model_Labor poModel;
    ...
    public void initialize() {
        ...
        poModel = new Model_Labor();
        poModel.setApplicationDriver(poGRider);
        poModel.setXML("Model_Labor");
        poModel.setTableName("Labor");
        poModel.initialize();
    }
    ...
    public JSONObject isEntryOkay() {
        ...
        if (poGRider.getUserLevel() < UserRight.SYSADMIN){
            ...
            if (poModel.getLaborId().isEmpty()){
                poJSON.put("result", "error");
                poJSON.put("message", "Labor must not be empty.");
                return poJSON;
            }
            
            if (poModel.getLaborName()== null ||  poModel.getLaborName().isEmpty()){
                poJSON.put("result", "error");
    ...
    public JSONObject voidTransaction() {
        ...
        if (poModel.getLaborId()== null || poModel.getLaborId().isEmpty()) {
            poJSON.put("result", "error");
            poJSON.put("message", "No record loaded.");
            return poJSON;
        }
